...
def checkidentity(worker):
    try:
        ...
        try:
            ...
            print("\033[91m===>[+] Key pair %s : %s had an error when attempting to list buckets: %s\033[0m" %(accessky,scrtky,e))
        ...
        try:
            ...
            b2 = b['Roles']
            b3 = str(b2).split(',')
            print("\033[92m%s : %s ====>  %s\033[0m"%(accessky,scrtky,b3))
            print("-------------------------------------------------------")

        except Exception as e:
            print("\033[91m===>[+] Key pair %s : %s had an error when attempting to list role info: %s\033[0m" %(accessky,scrtky,e))
        ...
        try:
            ...
            c2 = c['Groups']
            c3 = str(c2).split(',')
            print("\033[92m%s : %s ====>   %s\033[0m"%(accessky,scrtky,c3))
            print("-------------------------------------------------------")

        except Exception as e:
            print("\033[91m===>[+] Key pair %s : %s had an error when attempting to list group info: %s\033[0m" %(accessky,scrtky,e))
        ...
        try:
            ...
            d3 = str(d2).split(',')
            print("\033[92m%s : %s ====>   %s\033[0m"%(accessky,scrtky,d3))
            print("-------------------------------------------------------")

        except Exception as e:
            print("\033[91m===>[+] Key pair %s : %s had an error when attempting to list servicesspecificcredentials info: %s\033[0m" %(accessky,scrtky,e))
        ...
        try:
            ...
            for page in iterator:
                ...
                print("\033[92m%s : %s ====>   %s\033[0m"%(accessky,scrtky,secdict))
            print("-------------------------------------------------------")

        except Exception as e:
            print("\033[91m===>[+] Key pair %s : %s had an error when attempting to list secretsmanager info: %s\033[0m" %(accessky,scrtky,e))
        ...
        try:
            ...
            for pg in iterator2:
                ...
                print("\033[92m%s : %s ====>   %s\033[0m"%(accessky,scrtky,mydict))
            print("-------------------------------------------------------")

        except Exception as e:
            print("\033[91m===>[+] Key pair %s : %s had an error when attempting to list parameter store info: %s\033[0m" %(accessky,scrtky,e))
        ...
        try:
            ...
            print("\033[91m===>[+] Key pair %s : %s had an error when attempting to list dynamodb table info: %s\033[0m" %(accessky,scrtky,e))
